...
class SearchFeedVC: UIViewController {
...
extension SearchFeedVC: UICollectionViewDelegate, UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return self.feedList.count
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let feedReverse = Array(self.feedList.reversed())
        ...
        let cell : SearchFeedCell = collectionView.dequeueReusableCell(withReuseIdentifier: "SearchFeedCell", for: indexPath) as! SearchFeedCell
...
extension SearchFeedVC: UICollectionViewDelegateFlowLayout {
...
extension SearchFeedVC: searchFeedCellDelegate {
    func backToSearchVC() {
